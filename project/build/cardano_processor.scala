...
/**
 * Taken from lifty (a project of Mads Hartmann)
 * http://lifty.github.com
 */


class CardanoProcessor(info: ProjectInfo) extends ProcessorProject(info) with AssemblyProject {
  ...
  override def mainClass: Option[String] = Some("org.hnlab.cardano.processor.Cardano")
}
